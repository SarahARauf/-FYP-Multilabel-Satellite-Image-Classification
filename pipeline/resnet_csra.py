...
class ResNet_CSRA(ResNet):
    ...
    def __init__(self, num_heads, lam, num_classes, depth=101, input_dim=2048, cutmix=None): #change from 2048 to 6144 (3072)
       ...
       # self.additional_conv = nn.Conv2d(in_channels=6144, out_channels=3072, kernel_size=1)
